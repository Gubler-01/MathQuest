...
class Android():
    ...
    def feli(self):
        self.brinco_amplitud = 0.08  # Ajusta la amplitud del brinco
        self.brinco_frecuencia = 3  # Ajusta la frecuencia del brinco
        self.pos = self.brinco_amplitud * math.sin(self.brinco_frecuencia * glutGet(GLUT_ELAPSED_TIME) * 0.00025)
        glTranslatef(0.0, self.pos, 0.0)
        glColor3f(0, 0.75, 0)
        glPushMatrix()
        glTranslated(1, 0, 0)
        glRotate(-90, 1, 0, 0)
        ...
        glPushMatrix()
        # Posición del primer ojo frontal (en la parte de adelante de la media esfera)
        glTranslated(0.65, 0.3, -0.13)
        GLUtils.DrawSphere(0.055, 10, 10)  # Primer ojo frontal
        glPopMatrix()
    
        glPushMatrix()
        # Posición del primer ojo frontal (en la parte de adelante de la media esfera)
        glTranslated(0.65, 0.3, 0.13)
        GLUtils.DrawSphere(0.055, 10, 10)  # Segundo ojo frontal
        glPopMatrix()

        # Dibujamos dos cilindros delgados como antenas en la parte de arriba de la media esfera, junto a los ojos
        glColor3f(0, 0.75, 0)  # Color amarillo para las antenas
        glPushMatrix()
        # Posición de la primera antena (junto al primer ojo frontal)
        glTranslated(1, 0.55, -0.3)
        glRotate(55, 1, 0, 0)
        ...
        glPushMatrix()
        # Posición del primer ojo frontal (en la parte de adelante de la media esfera)
        glTranslated(0.58, 0.2, 0)
        glRotate(90, 1, 0, 0)
        GLUtils.DrawHalfSphere(0.15, 10, 10)  # Primer ojo frontal
        glPopMatrix()
    ...
    def duda(self):
        ...
        # Posición del primer ojo frontal (en la parte de adelante de la media esfera)
        glTranslated(0.58, 0.2, -0.13)
        GLUtils.DrawSphere(0.05, 10, 10)  # Primer ojo frontal
        glPopMatrix()
    
        glPushMatrix()
        # Posición del primer ojo frontal (en la parte de adelante de la media esfera)
        glTranslated(0.58, 0.2, 0.13)
        GLUtils.DrawSphere(0.05, 10, 10)  # Segundo ojo frontal
        glPopMatrix()
        ...
        # Dibujar cejas arriba de los ojos
        glColor3f(0.3, 0.3, 0.3)  # Color gris para las cejas
        glPushMatrix()
        # Posición de la primera ceja (sobre el primer ojo frontal)
        glTranslated(0.52, 0.3, -0.22)
        glRotate(0, 1, 1, 0)  # Rotar la ceja para que esté horizontal
        # Cilindro delgado como ceja con radio de 0.02 y longitud de 0.15
        glutSolidCylinder(0.02, 0.15, 20, 20)
        glPopMatrix()

        glPushMatrix()
        # Posición de la segunda ceja (sobre el segundo ojo frontal)
        glTranslated(0.52, 0.27, 0.07)
        glRotate(-45, 1, 1, 0)  # Rotar la ceja para que esté horizontal
        # Cilindro delgado como ceja con radio de 0.02 y longitud de 0.15
        glutSolidCylinder(0.02, 0.15, 20, 20)
        glPopMatrix()
    ...
    def levBrazo(self):
        self.brinco_amplitud = 0.08  # Ajusta la amplitud del brinco
        self.brinco_frecuencia = 3  # Ajusta la frecuencia del brinco
        self.pos = self.brinco_amplitud * math.sin(self.brinco_frecuencia * glutGet(GLUT_ELAPSED_TIME) * 0.001)
        glColor3f(0, 0.75, 0)
        # Poner la media esfera encima del cilindro (parte de arriba)
        glPushMatrix()
        glTranslatef(0.0, self.pos, 0.0)
    ...
    def llorar(self):
        ...
        # Dibujar cejas arriba de los ojos
        glColor3f(0, 0.3, 1)  # Color gris para las cejas
        glPushMatrix()
        glTranslatef(0.0, self.pos, 0.0)
        # Posición de la primera ceja (sobre el primer ojo frontal)
        glTranslated(0.52, 0.17, -0.13)
        glRotate(90, 1, 0, 0)  # Rotar la ceja para que esté horizontal
        # Cilindro delgado como ceja con radio de 0.02 y longitud de 0.15
        glutSolidCylinder(0.02, 0.4, 20, 20)
        glPopMatrix()
